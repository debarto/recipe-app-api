...
def image_upload_url(recipe_id):
    """Return the URL for recipe image uploads"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user('t@fake.com', 'testpass')
    ...
    def test_recipes_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user('q.fake.com', 'pass2334')
    ...
    def test_full_recipe_update(self):
        ...
        payload = {'title': 'Spaghetti', 'time_minutes': 25, 'price': 8}
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user('k@fake.com', 'testpass')
        self.client.force_authenticate(self.user)
    ...
    def test_filter_recipes_by_tag(self):
        ...
        recipe3 = sample_recipe(user=self.user, title="Drunken Noodles")
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='peanuts')
